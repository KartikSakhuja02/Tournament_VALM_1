...
class ManagerRegistrationButtons(discord.ui.View):
    ...
    async def register_manager(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Check if user already has an active manager registration thread (including temp placeholders)
        ...
        try:
            ...
            welcome_embed = discord.Embed(
                ...
                description=(
                    ...
                    "Please select which team you want to manage from the dropdown(s) below.\n\n"
            ...
            try:
                ...
                print(f"✓ Sent team selection message(s) to thread {thread.id}")
